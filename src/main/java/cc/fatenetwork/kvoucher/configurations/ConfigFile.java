package cc.fatenetwork.kvoucher.configurations;
...
public class ConfigFile {
    ...
    public ConfigFile(String name) {
        this.name = name;
        this.file = new File(Voucher.getPlugin().getDataFolder(), name + ".yml");
        if (!this.file.exists()) {
            Voucher.getPlugin().saveResource(name + ".yml", false);
        }
